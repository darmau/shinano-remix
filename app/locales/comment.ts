export default {
  "zh": {
    ...
    "signup": "注册",
    "login": "登录",
    "moderation_notice": "未登录用户的评论需要等待审核，并且无法接收回复通知。您填写的邮箱将不会被公开。",
    "author": "作者",
    "reply": "回复",
    "cancel_reply": "取消回复",
  ...
  "en": {
    ...
    "signup": "Sign up",
    "login": "Log in",
    "moderation_notice": "Guest comments are held for review before appearing. They cannot receive reply notifications. Your email will not be publicly displayed.",
    "author": "Author",
    "reply": "Reply",
  ...
  "jp": {
    ...
    "signup": "サインアップ",
    "login": "ログイン",
    "moderation_notice": "未ログインのコメントは承認後に表示されます。返信通知を受け取ることはできません。メールアドレスは公開されません。",
    "author": "著者",
    "reply": "返信",
