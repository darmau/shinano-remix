...
import { a8 as getDefaultExportFromCjs } from './astro/server_D3oA7eJe.mjs';
...
async function check(Component, props, children) {
  ...
  if (Component.prototype != null && typeof Component.prototype.render === "function") {
    return G.Component.isPrototypeOf(Component) || G.PureComponent.isPrototypeOf(Component);
  }
...
async function renderToStaticMarkup(Component, props, { default: children, ...slotted }, metadata) {
  ...
  for (const [key, value] of Object.entries(slotted)) {
    ...
    slots[name] = G.createElement(static_html_default, {
  ...
  if (newChildren != null) {
    newProps.children = G.createElement(static_html_default, {
      hydrate: needsHydration(metadata),
      value: newChildren
    });
  }
  ...
  const vnode = G.createElement(Component, newProps);
  const renderOptions = {
...
export { G, renderers as a, requireReact as b, requireReactDom as c, reactExports as r, t };
